...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget5.setGeometry(QRect(30, 520, 346, 92))
        ...
        self.label_11 = QLabel(self.Source)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(30, 20, 84, 26))
        self.samplingModeCombo = QComboBox(self.Source)
        ...
        self.stackedSourceWidget = QStackedWidget(self.Source)
        ...
        self.stackedSensorWidget.addTab(self.Source, "")
        self.Sensor = QWidget()
        ...
        self.GDTSb.setValue(0.010000000000000)
        ...
        self.MSISb.setValue(100)
        self.MSISb.setDisplayIntegerBase(10)
        ...
        self.MEPSb.setValue(0.500000000000000)
        ...
        sizePolicy1.setHeightForWidth(self.stopSimu.sizePolicy().hasHeightForWidth())
        self.stopSimu.setSizePolicy(sizePolicy1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stackedSensorWidget.setTabText(self.stackedSensorWidget.indexOf(self.Source), QCoreApplication.translate("MainWindow", u"Source", None))
        ...
        self.Propagation.setTitle(QCoreApplication.translate("MainWindow", u"Propagation", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"Geometrical distance tolerance", None))
        self.GDTSb.setSuffix(QCoreApplication.translate("MainWindow", u"mm", None))
        self.label_28.setText(QCoreApplication.translate("MainWindow", u"Maximum number of surface interactions", None))
        self.WeightCb.setText(QCoreApplication.translate("MainWindow", u"Weight", None))
        self.label_29.setText(QCoreApplication.translate("MainWindow", u"Maximum energy percentage", None))
        self.MEPSb.setSpecialValueText("")
        self.MEPSb.setSuffix(QCoreApplication.translate("MainWindow", u"%", None))
        self.stackedSensorWidget.setTabText(self.stackedSensorWidget.indexOf(self.Options), QCoreApplication.translate("MainWindow", u"Options", None))
        self.BuildPb.setText(QCoreApplication.translate("MainWindow", u"Build Speos Simulation", None))
        self.PreviewPb.setText(QCoreApplication.translate("MainWindow", u"Preview", None))
